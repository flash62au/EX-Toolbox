...
public class PreferencesActivity extends AppCompatActivity implements PreferenceFragmentCompat.OnPreferenceStartScreenCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        Log.d("EX_Toolbox", "PreferencesActivity: onCreate()");
        ...
        mainapp.settings_msg_handler = new PreferencesActivity.settings_handler(Looper.getMainLooper());

        //put pointer to this activity's message handler in main app's shared variable (If needed)
        mainapp.preferences_msg_handler = new PreferencesActivity.settings_handler(Looper.getMainLooper());

        OnBackPressedCallback callback = new OnBackPressedCallback(true /* enabled by default */) {
            @Override
            public void handleOnBackPressed() {
                Log.d("EX_Toolbox", "PreferencesActivity: handleOnBackPressed()");
        ...
        if (toolbar != null) {
            ...
            mainapp.setToolbarTitle(toolbar, statusLine, screenNameLine,
                    ...
                    "");
            Log.d("EX_Toolbox", "PreferencesActivity: Set toolbar");
        }
...
//        mainapp.applyTheme(this,true);
    ...
    protected void onStart() {
        Log.d("EX_Toolbox", "PreferencesActivity: onStart()");
        super.onStart();
    }

    @Override
    protected void onStop() {
        Log.d("EX_Toolbox", "PreferencesActivity: onStop()");
        super.onStop();
    }

    @Override
    protected void onDestroy() {
        Log.d("EX_Toolbox", "PreferencesActivity: onDestroy()");
        super.onDestroy();
    ...
    public void forceRestartApp(int forcedRestartReason) {
        Log.d("EX_Toolbox", "PreferencesActivity: forceRestartApp() - forcedRestartReason: " + forcedRestartReason);
    ...
    public void forceReLaunchApp(int forcedRestartReason) {
        Log.d("EX_Toolbox", "PreferencesActivity: forceRelaunchApp() ");
    ...
    public void shareFileNow() {
        Log.d("EX_Toolbox", "PreferencesActivity: shareFileNow()");
    ...
    public ArrayList<File> getFilesForDialog() {
        Log.d("EX_Toolbox", "PreferencesActivity: getFilesForDialog()");
            ...
            if (dir.exists() && dir.isDirectory()) {
                ...
                if (filesList != null) {
                    for (File file : filesList) {
                        logFiles.add(file);
                        Log.d("EX_Toolbox", "PreferencesActivity:  getFilesForDialog(): Found: " + file.getName());
                    }
                    Collections.sort(logFiles, (file1, file2) -> file1.getName().compareTo(file2.getName()));
                }
            }
        } catch (Exception e) {
            Log.e("EX_Toolbox", "PreferencesActivity:  getFilesForDialog(): Error trying to find log files", e);
    ...
    private void showFileSelectionDialog() {
        Log.d("EX_Toolbox", "PreferencesActivity: showFileSelectionDialog()");
...
//    }
    ...
    private void shareFile(File file, String fileName) {
        Log.d("EX_Toolbox", "PreferencesActivity: shareFile()");
        Uri fileUri = FileProvider.getUriForFile(
                this,
                getApplicationContext().getPackageName() + ".fileprovider",
                file
    ...
    public void reload() {
        ...
        Log.d("EX_Toolbox", "PreferencesActivity: Forcing activity to recreate");
        recreate();
    }

    private void resetPreferencesDialog() {
        Log.d("EX_Toolbox", "PreferencesActivity: Resetting preferences");
    ...
    private void resetPreferences() {
        Log.d("EX_Toolbox", "PreferencesActivity: resetPreferences()");
        SharedPreferences.Editor prefEdit = prefs.edit();
        prefEdit.clear();
        prefEdit.commit();
        Log.d("EX_Toolbox", "PreferencesActivity: Reset succeeded");
    ...
    private void delete_auto_import_settings_files() {
        Log.d("EX_Toolbox", "PreferencesActivity: delete_auto_import_settings_files()");
...
//            File dir = new File(sdcard_path, DCC_EX_DIR); // in case the folder does not already exist
    ...
    private void delete_settings_file(String file_name) {
        Log.d("EX_Toolbox", "PreferencesActivity: delete_settings_file()");
        if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
//            File sdcard_path = Environment.getExternalStorageDirectory();
//            File settings_file = new File(sdcard_path, "ex_toolbox/" + file_name);
            ...
            if (settings_file.exists()) {
                if (settings_file.delete()) {
                    Log.d("EX_Toolbox", "PreferencesActivity: " + file_name + " deleted");
                } else {
                    Log.e("EX_Toolbox", "PreferencesActivity: " + file_name + " NOT deleted");
                }
            }
        }
    }
    ...
    public boolean onKeyDown(int key, KeyEvent event) {
        Log.d("EX_Toolbox", "PreferencesActivity: onKeyDown()");
        mainapp.exitDoubleBackButtonInitiated = 0;
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        Log.d("EX_Toolbox", "PreferencesActivity: onCreateOptionsMenu()");
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        Log.d("EX_Toolbox", "PreferencesActivity: onActivityResult()");
...
//                }
            ...
            Log.e("EX_Toolbox", "PreferencesActivity: Loading background image Failed: " + e.getMessage());
        }
    ...
    protected boolean limitIntPrefValue(PreferenceScreen prefScreen, SharedPreferences sharedPreferences, String key, int minVal, int maxVal, String defaultVal) {
        Log.d("EX_Toolbox", "PreferencesActivity: limitIntPrefValue()");
    ...
    protected boolean limitFloatPrefValue(PreferenceScreen prefScreen, SharedPreferences sharedPreferences, String key, Float minVal, Float maxVal, String defaultVal) {
        Log.d("EX_Toolbox", "PreferencesActivity: limitFloatPrefValue()");
        boolean isValid = true;
        EditTextPreference prefText = (EditTextPreference) prefScreen.findPreference(key);
        try {
    ...
    private void enableDisablePreference(PreferenceScreen prefScreen, String key, boolean enable) {
        Log.d("EX_Toolbox", "PreferencesActivity: enableDisablePreference(): key: " + key);
    ...
    public void loadSharedPreferences(){
        Log.d("EX_Toolbox", "PreferencesActivity: loadSharedPreferences()");
        prefs = getSharedPreferences("dcc_ex.ex_toolbox_preferences", 0);
    }

    private void getConnectionsList() {
        Log.d("EX_Toolbox", "PreferencesActivity: getConnectionsList()");
        String host_name;
...
//                File connections_list_file = new File(sdcard_path, "ex_toolbox/connections_list.txt");
            ...
            Log.e("EX_Toolbox", "PreferencesActivity: Error reading recent connections list: " + errMsg);
...
//        private String[] prefHostImportExportEntryValuesFound = {"None"};
        ...
        public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
            Log.d("EX_Toolbox", "PreferencesActivity: SettingsFragment onCreatePreferences()");
                setPreferencesFromResource(R.xml.preferences, rootKey);

            Activity a = getActivity();
//            if(a instanceof PreferencesActivity) {
...
//            }
        ...
        @Override
        public void onPause() {
            Log.d("EX_Toolbox", "PreferencesActivity: SettingsFragment onPause()");
            super.onPause();
        ...
        public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
            Log.d("EX_Toolbox", "PreferencesActivity: onSharedPreferenceChanged(): key: " + key);
...
//                        break;
        ...
        void setPreferencesUI() {
            Log.d("EX_Toolbox", "PreferencesActivity: setPreferencesUI()");
...
//                mainapp.applyTheme(parentActivity, true);
        ...
        public void removePreference(Preference preference) {
            try {
                ...
                Log.d("EX_Toolbox", "PreferencesActivity: removePreference: failed: " + preference);
            }
        }
...
// //                Log.d("EX_Toolbox", "PreferencesActivity: hideAdvancedPreferences(): " + advancedPreference1);
                    ...
                    if (advancedPreference != null) {
                        ...
                        Log.d("EX_Toolbox", "PreferencesActivity: '" + advancedPreference1 + "' not found.");
                    }
                }
            }
        }
...
//                    ContextCompat.getColor(getContext(), R.color.background_material_light));
        ...
        @Override
        public void onPause() {
            Log.d("EX_Toolbox", "PreferencesActivity: SettingsFragment onPause() 2");
            super.onPause();
        ...
        public void removeSubPreference(Preference preference) {
            try {
                ...
                Log.d("EX_Toolbox", "PreferencesActivity: removeSubPreference: failed: " + preference);
            }
        }
...
// //                Log.d("EX_Toolbox", "PreferencesActivity: hideAdvancedPreferences(): " + advancedPreference1);
                    ...
                    if (advancedSubPreference != null) {
                        ...
                        Log.d("EX_Toolbox", "PreferencesActivity: '" + advancedSubPreference1 + "' not found.");
                    }
                }
            }
        }
