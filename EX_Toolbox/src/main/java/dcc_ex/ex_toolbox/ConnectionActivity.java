...
//        CvProgrammerActivity.addFlags(Intent.FLAG_ACTIVITY_NO_HISTORY);
...
//            connections_list = new ArrayList<>();
        ...
        if (prefs.getBoolean("prefForcedRestart", false)) { // if forced restart from the preferences
            ...
            if (mainapp.prefsForcedRestart(prefForcedRestartReason)) {
                Intent in = new Intent().setClass(this, PreferencesActivity.class);
...
//        runIntro = false;
    ...
    private void calculateDisplayMetrics() {
        Log.d("EX_Toolbox","ConnectionActivity: calculateDisplayMetrics()");
        DisplayMetrics dm = new DisplayMetrics();
        getWindowManager().getDefaultDisplay().getMetrics(dm);
...
//                }
//            } else {
//                if (!phi.isPermissionGranted(ConnectionActivity.this, PermissionsHelper.NEARBY_WIFI_DEVICES)) {
//                    phi.requestNecessaryPermissions(ConnectionActivity.this, PermissionsHelper.NEARBY_WIFI_DEVICES);
//                }
//            }
...
//            navigateToHandler(PermissionsHelper.READ_CONNECTION_LIST);
    ...
    public void navigateToHandler(@RequestCodes int requestCode) {
        Log.d("EX_Toolbox", "ConnectionActivity: navigateToHandler:" + requestCode);
