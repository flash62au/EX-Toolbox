...
public class TrackManagerActivity extends AppCompatActivity implements GestureOverlayView.OnGestureListener {
...
//                    refreshDccexView();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.track_manager_page);
...
//        final List<String> dccTrackTypeValuesList = new ArrayList<>(Arrays.asList(dccExTrackTypeEntryValuesArray));
        ...
        OnBackPressedCallback callback = new OnBackPressedCallback(true /* enabled by default */) {
            ...
            public void handleOnBackPressed() {
                mainapp.checkExit(TrackManagerActivity.this);
            }
        };
    ...
    public void onResume() {
        Log.d("EX_Toolbox", "TrackManagerActivity.onResume() called");
        mainapp.applyTheme(this);
    ...
    public void onDestroy() {
        super.onDestroy();
        Log.d("EX_Toolbox", "TrackManagerActivity.onDestroy() called");
    ...
    public void forceRestartApp(int forcedRestartReason) {
        Log.d("EX-Toolbox", "TrackManagerActivity.forceRestartApp() ");
