...
public class NeopixelActivity extends AppCompatActivity implements GestureOverlayView.OnGestureListener {
...
//                    refreshDccexView();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.neopixel_page);
...
//        resetNeopixelTextFields();
        ...
        OnBackPressedCallback callback = new OnBackPressedCallback(true /* enabled by default */) {
            ...
            public void handleOnBackPressed() {
                mainapp.checkExit(NeopixelActivity.this);
            }
        };
