...
public class LocosActivity extends AppCompatActivity implements GestureOverlayView.OnGestureListener {
...
//                    refreshDccexView();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.locos_page);
        ...
        locos_list_adapter = new SimpleAdapter(this, locos_list, R.layout.locos_list_item,
...
//
        ...
        OnBackPressedCallback callback = new OnBackPressedCallback(true /* enabled by default */) {
            ...
            public void handleOnBackPressed() {
                mainapp.checkExit(LocosActivity.this);
            }
        };
    ...
    public void onResume() {
        Log.d("EX_Toolbox", "LocosActivity.onResume() called");
        mainapp.applyTheme(this);
    ...
    @Override
    public void onPause() {
        Log.d("EX_Toolbox", "LocosActivity.onPause() called");
        super.onPause();
    ...
    public void onStart() {
        super.onStart();
        Log.d("EX_Toolbox", "LocosActivity.onStart() called");
        // put pointer to this activity's handler in main app's shared variable
        if (mainapp.locos_msg_handler == null)
            mainapp.locos_msg_handler = new locos_handler(Looper.getMainLooper());
    }
    ...
    public void onDestroy() {
        super.onDestroy();
        Log.d("EX_Toolbox", "LocosActivity.onDestroy() called");
    ...
    public void forceRestartApp(int forcedRestartReason) {
        Log.d("EX-Toolbox", "LocosActivity.forceRestartApp() ");
