...
public class SpeedMatchingActivity extends AppCompatActivity implements GestureOverlayView.OnGestureListener {
...
//        prefs = getSharedPreferences("dcc_ex.ex_toolbox_preferences", 0);
        ...
        setContentView(R.layout.speed_matching_page);
...
//        dccexSendsScrollView = findViewById(R.id.ex_DccexSendsScrollView);
        ...
        OnBackPressedCallback callback = new OnBackPressedCallback(true /* enabled by default */) {
            ...
            public void handleOnBackPressed() {
                mainapp.checkExit(SpeedMatchingActivity.this);
            }
        };
    ...
    public void onResume() {
        Log.d("EX_Toolbox", "SpeedMatchingActivity.onResume() called");
        mainapp.applyTheme(this);
    ...
    @Override
    public void onPause() {
        Log.d("EX_Toolbox", "TrackManagerActivity.onPause() called");
        super.onPause();
    ...
    public void onStart() {
        super.onStart();
        Log.d("EX_Toolbox", "TrackManagerActivity.onStart() called");
        // put pointer to this activity's handler in main app's shared variable
        if (mainapp.speed_matching_msg_handler == null)
            mainapp.speed_matching_msg_handler = new speed_matching_handler(Looper.getMainLooper());
    }
    ...
    public void onDestroy() {
        super.onDestroy();
        Log.d("EX_Toolbox", "SpeedMatchingActivity.onDestroy() called");
    ...
    public void forceRestartApp(int forcedRestartReason) {
        Log.d("EX-Toolbox", "SpeedMatchingActivity.forceRestartApp() ");
