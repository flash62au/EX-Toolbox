...
public class SensorsActivity extends AppCompatActivity implements GestureOverlayView.OnGestureListener {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case message_type.RECEIVED_SENSOR: {
                    String s = msg.obj.toString();
                    Log.d("EX_Toolbox", "SensorsActivity: RECEIVED_SENSOR: " + s);
                    if (s.length() > 0) {
                ...
                case message_type.RECEIVED_ADDITIONAL_SENSOR: {
                    String s = msg.obj.toString();
                    Log.d("EX_Toolbox", "SensorsActivity: RECEIVED_ADDITIONAL_SENSOR: " + s);
                    if (s.length() > 0) {
                        setIdsFromResponses();
                        refreshDccexSensorsView();
                    }
...
//
        ...
        OnBackPressedCallback callback = new OnBackPressedCallback(true /* enabled by default */) {
            ...
            public void handleOnBackPressed() {
                mainapp.checkExit(SensorsActivity.this);
            }
        };
    ...
    public void onResume() {
        Log.d("EX_Toolbox", "SensorsActivity.onResume() called");
        mainapp.applyTheme(this);
    ...
    @Override
    public void onPause() {
        Log.d("EX_Toolbox", "SensorsActivity.onPause() called");
        super.onPause();
    ...
    public void onStart() {
        super.onStart();
        Log.d("EX_Toolbox", "SensorsActivity.onStart() called");
        // put pointer to this activity's handler in main app's shared variable
        if (mainapp.sensors_msg_handler == null)
            mainapp.sensors_msg_handler = new sensors_handler();
    }
    ...
    public void onDestroy() {
        super.onDestroy();
        Log.d("EX_Toolbox", "SensorsActivity.onDestroy() called");
...
/*        } else if (item.getItemId() == R.id.preferences_mnu) {
                navigateAway(false, PreferencesActivity.class);
                return true;*/
    ...
    public void forceRestartApp(int forcedRestartReason) {
        Log.d("EX-Toolbox", "SensorsActivity.forceRestartApp() ");
