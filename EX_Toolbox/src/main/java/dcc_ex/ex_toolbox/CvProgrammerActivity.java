...
public class CvProgrammerActivity extends AppCompatActivity implements android.gesture.GestureOverlayView.OnGestureListener, cvBitCalculator.OnConfirmListener {
...
//                    refreshDccexView();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cv_programmer_page);
...
//            hideSendsButton.setOnClickListener(hideSendsClickListener);
        ...
        OnBackPressedCallback callback = new OnBackPressedCallback(true /* enabled by default */) {
            ...
            public void handleOnBackPressed() {
                Log.d("EX_Toolbox", "CvProgrammerActivity: handleOnBackPressed()");
                mainapp.checkExit(CvProgrammerActivity.this);
            }
        };
    ...
    public void onResume() {
        Log.d("EX_Toolbox", "CvProgrammerActivity: onResume() called");
        mainapp.applyTheme(this);
        super.onResume();
    ...
    @Override
    public void onPause() {
        Log.d("EX_Toolbox", "CvProgrammerActivity: onPause() called");
        super.onPause();
    ...
    @Override
    public void onStart() {
        Log.d("EX_Toolbox", "CvProgrammerActivity: onStart() called");
        super.onStart();
        // put pointer to this activity's handler in main app's shared variable
        if (mainapp.cv_programmer_msg_handler == null)
            mainapp.cv_programmer_msg_handler = new cv_programmer_handler(Looper.getMainLooper());
    ...
    @Override
    public void onStop() {
        Log.d("EX_Toolbox", "CvProgrammerActivity: onStop() called");
        super.onStop();
    }
    ...
    public void onDestroy() {
        Log.d("EX_Toolbox", "CvProgrammerActivity: onDestroy() called");
        super.onDestroy();
    ...
    public boolean onKeyDown(int key, KeyEvent event) {
        Log.d("EX_Toolbox", "CvProgrammerActivity: onKeyDown()");
...
//            overridePendingTransition(mainapp.getFadeIn(swipe, deltaX), mainapp.getFadeOut(swipe, deltaX));
    ...
    public void forceRestartApp(int forcedRestartReason) {
        Log.d("EX-Toolbox", "CvProgrammerActivity.forceRestartApp() ");
    ...
    private void startNewCvProgrammerActivity() {
        ...
        Intent newCvProgrammer = new Intent().setClass(this, CvProgrammerActivity.class);
        this.finish();
