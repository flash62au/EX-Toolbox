...
public class CurrentsActivity extends AppCompatActivity implements GestureOverlayView.OnGestureListener {
...
//                    refreshDccexView();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.currents_page);
...
//
        ...
        OnBackPressedCallback callback = new OnBackPressedCallback(true /* enabled by default */) {
            ...
            public void handleOnBackPressed() {
                mainapp.checkExit(CurrentsActivity.this);
            }
        };
    ...
    public void onResume() {
        Log.d("EX_Toolbox", "CurrentsActivity.onResume() called");
        mainapp.applyTheme(this);
    ...
    @Override
    public void onPause() {
        Log.d("EX_Toolbox", "CurrentsActivity.onPause() called");
        super.onPause();
    ...
    public void onStart() {
        super.onStart();
        Log.d("EX_Toolbox", "CurrentsActivity.onStart() called");
        // put pointer to this activity's handler in main app's shared variable
        if (mainapp.currents_msg_handler == null)
            mainapp.currents_msg_handler = new currents_handler(Looper.getMainLooper());
    }
    ...
    public void onDestroy() {
        super.onDestroy();
        Log.d("EX_Toolbox", "CurrentsActivity.onDestroy() called");
    ...
    public void forceRestartApp(int forcedRestartReason) {
        Log.d("EX-Toolbox", "CurrentsActivity.forceRestartApp() ");
