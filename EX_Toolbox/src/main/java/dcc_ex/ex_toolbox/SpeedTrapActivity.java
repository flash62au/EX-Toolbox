...
public class SpeedTrapActivity extends AppCompatActivity implements GestureOverlayView.OnGestureListener {
...
//        toolbarHeight = toolbar.getHeight() + statusLine.getHeight() + screenNameLine.getHeight();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.speed_trap_page);
...
//        dccexWriteInfoLayout = findViewById(R.id.ex_writeInfoLayout);
        ...
        OnBackPressedCallback callback = new OnBackPressedCallback(true /* enabled by default */) {
            ...
            public void handleOnBackPressed() {
                mainapp.checkExit(SpeedTrapActivity.this);
            }
        };
    ...
    public void onResume() {
        Log.d("EX_Toolbox", "SpeedTrapActivity.onResume() called");
        mainapp.applyTheme(this);
        super.onResume();
    ...
    @Override
    public void onPause() {
        Log.d("EX_Toolbox", "SpeedTrapActivity.onPause() called");
        super.onPause();
    ...
    public void onStart() {
        super.onStart();
        Log.d("EX_Toolbox", "SpeedTrapActivity.onStart() called");
        // put pointer to this activity's handler in main app's shared variable
        if (mainapp.speed_trap_msg_handler == null)
            mainapp.speed_trap_msg_handler = new SpeedTrapMessageHandler(Looper.getMainLooper());
    }
    ...
    public void onDestroy() {
        super.onDestroy();
        Log.d("EX_Toolbox", "SpeedTrapActivity.onDestroy() called");
...
//            overridePendingTransition(mainapp.getFadeIn(swipe, deltaX), mainapp.getFadeOut(swipe, deltaX));
    ...
    public void forceRestartApp(int forcedRestartReason) {
        Log.d("EX-Toolbox", "SpeedTrapActivity.forceRestartApp() ");
    ...
    private void startNewSpeedTrapActivity() {
        ...
        Intent newCvProgrammer = new Intent().setClass(this, SpeedTrapActivity.class);
        this.finish();
