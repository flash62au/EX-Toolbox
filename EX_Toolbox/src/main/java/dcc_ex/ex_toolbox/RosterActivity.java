...
public class RosterActivity extends AppCompatActivity implements GestureOverlayView.OnGestureListener {
...
//                    refreshDccexView();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.roster_page);
...
//
        ...
        OnBackPressedCallback callback = new OnBackPressedCallback(true /* enabled by default */) {
            ...
            public void handleOnBackPressed() {
                mainapp.checkExit(RosterActivity.this);
            }
        };
    ...
    public void onResume() {
        Log.d("EX_Toolbox", "RosterActivity.onResume() called");
        mainapp.applyTheme(this);
    ...
    @Override
    public void onPause() {
        Log.d("EX_Toolbox", "RosterActivity.onPause() called");
        super.onPause();
    ...
    public void onStart() {
        super.onStart();
        Log.d("EX_Toolbox", "RosterActivity.onStart() called");
        // put pointer to this activity's handler in main app's shared variable
        if (mainapp.roster_msg_handler == null)
            mainapp.roster_msg_handler = new roster_handler();
    }
    ...
    public void onDestroy() {
        super.onDestroy();
        Log.d("EX_Toolbox", "RosterActivity.onDestroy() called");
...
/*        } else if (item.getItemId() == R.id.preferences_mnu) {
    ...
    public void forceRestartApp(int forcedRestartReason) {
        Log.d("EX-Toolbox", "RosterActivity.forceRestartApp() ");
